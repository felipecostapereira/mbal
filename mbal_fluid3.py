    ...
    if nfluids > 1:
        ...
        with col6:
            ...
            if fluid_input == "Analogue":
                ...
                axs[2].plot(list_fluids[selected_analogue2]['Pressure'],list_fluids[selected_analogue2]['Visc'],'b-',label=selected_analogue2)
    ...
    if nfluids > 2:
        ...
        with col8:
            ...
            if fluid_input == "Analogue":
                ...
                axs[2].plot(list_fluids[selected_analogue3]['Pressure'],list_fluids[selected_analogue3]['Visc'],'b-',label=selected_analogue3)
                axs[2].plot(pressures,viscs,'r-',label='Fluid 2')
                axs[2].set_xlabel('Pressure')
                axs[2].set_ylabel('Visc (cp)')
                axs[2].legend()
